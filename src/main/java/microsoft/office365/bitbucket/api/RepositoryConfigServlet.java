...
import microsoft.office365.bitbucket.persistence.DummyWebHookConfiguration;
...
public class RepositoryConfigServlet extends HttpServlet
{
	...
	protected void render(HttpServletResponse resp, String templateName, Map<String, Object> data) throws IOException, ServletException
	{
		...
		try
		{
			soyTemplateRenderer.render(resp.getWriter(), "microsoft.office365.bitbucket.office-365-connector:templates-soy", templateName, data);
		}
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		if (queryParams.stream().anyMatch(nameValuePair -> nameValuePair.getName().equals("edit")))
		{
			...
			String template = "microsoft.office365.templates.edit";
		...
		else
		{
			...
			String template = "microsoft.office365.templates.repositorySettings";
